...
contract StickersV2 is ERC721, Authentication, IntegrityInterface {
    ...
    //public vars
    StickerManager public stickerManager;
    ...
    constructor(
        ...
        stickerManager = StickerManager(oracleDestination);
    ...
    function request(
        ...
        StickerManager.RegistrationObject memory obj = stickerManager
